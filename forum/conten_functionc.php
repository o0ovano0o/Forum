<?php
	...
	function dispsubcategories($parent_id) {
		...
		while ($row = mysqli_fetch_assoc($select)) {
			echo "<tr><td class='category_title'><a href='/forum/topicss/".$row['cat_id']."/".$row['subcat_id']."'>
	...
	function disptopics($cid, $scid) {
		...
		if (mysqli_num_rows($select) != 0) {
			...
			echo "<p>this category has no topics yet!  <a href='/forum/newtopics/".$cid."/".$scid."'>
	...
	function replytopost($cid, $scid, $tid) {
		...
		<form action='/forum/addreplys.php?cid=".$cid."&scid=".$scid."&tid=".$tid."' method='POST'>
			  <p>Comment: </p>
			  <textarea cols='80'  rows='20' id='comment' name='comment' style='width:90%;'></textarea><br />
