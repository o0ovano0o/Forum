...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 10, 2019 lúc 08:00 PM
...
(6, 1, 1, 'van1199', 'Topic AweSome', 'this is awesome!!!!!', '2019-04-09 23:16:43', 74, 6),
...
--
ALTER TABLE `categories`
  MODIFY `cat_id` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `topics`
  MODIFY `topic_id` int(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `users`
--
ALTER TABLE `users`
  MODIFY `user_id` int(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
