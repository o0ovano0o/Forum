...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 11, 2019 lúc 07:24 PM
...
(6, 1, 1, 'van1199', 'Topic AweSome', 'this is awesome!!!!!', '2019-04-09 23:16:43', 75, 6),
...
--
ALTER TABLE `replies`
  MODIFY `reply_id` int(3) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
